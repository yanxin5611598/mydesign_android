...
/**
 * 城市选择的ListView*/
public class MyCityListView extends View{
    ...
    public MyCityListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.mContext = context;
    }
    public MyCityListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }
    public MyCityListView(Context context) {
        super(context);
        this.mContext = context;
    }
    @Override
