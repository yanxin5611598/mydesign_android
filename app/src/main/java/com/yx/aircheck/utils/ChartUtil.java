...
public class ChartUtil {
    ...
    public static void showChart(Context context, LineChart lineChart, List<String> xDataList,
        ...
        // 标题字体颜色
        lineChart.setDescriptionColor(Color.parseColor("#333333"));
        ...
        // 图例上的字体颜色
        mLegend.setTextColor(Color.parseColor("#58ACED"));
    ...
    private static LineData setLineData(Context context, List<String> xDataList, List<Entry> yDataList,
        ...
        // 显示颜色
        lineDataSet.setColor(Color.parseColor("#58ACED"));
        // 圆形的颜色
        lineDataSet.setCircleColor(Color.parseColor("#58ACED"));
        // 高亮的线的颜色
        lineDataSet.setHighLightColor(Color.parseColor("#FFC800"));
        // 设置坐标点的颜色
        lineDataSet.setFillColor(Color.parseColor("#58ACED"));
        // 设置坐标点为空心环状
